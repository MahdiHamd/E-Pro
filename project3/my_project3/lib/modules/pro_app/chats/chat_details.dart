  ...
  Widget build(BuildContext context) {
    return Builder(
      builder: (BuildContext context) {
        ProCubit.get(context).getMessages(
          ...
          builder: (context, state) {
            return Scaffold(
              ...
              body: ConditionalBuilderRec(
                condition: ProCubit.get(context).messages.length > 0,
                      ...
                      Expanded(
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            var message = ProCubit.get(context).messages[index];

                            if (ProCubit.get(context).userModel!.uId ==
                                message.senderId)
                          ...
                          itemCount: ProCubit.get(context).messages.length,
                        ),
                      ),
                      Container(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: MaterialButton(
                                onPressed: () {
                                  ProCubit.get(context).sendMessage(
                                    receiverId: userModel!.uId!,
